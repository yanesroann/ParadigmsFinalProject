...
def start_service():
    ...
    dispatcher.connect('recommendations_key_options', '/recommendations/:num', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
    ...
    dispatcher.connect('books_options', '/authors/', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
    dispatcher.connect('books_key_options', '/authors/:key', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
    dispatcher.connect('books_options', '/years/:key', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
    dispatcher.connect('books_options', '/genres/', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
    dispatcher.connect('books_key_options', '/genres/:key', controller=optionsController, action='OPTIONS', conditions=dict(method=['OPTIONS']))
